...
Existing R packages handle aspects like normalization or batch correction, but none specifically combine outlier detection, batch effect adjustment, and miRNA stability assessment in one workflow. `miRNARefine` fills this gap, providing a set of functions that can be used independently or combined into a pipeline for miRNA data refinement.
