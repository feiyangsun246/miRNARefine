...
Hastie T, Tibshirani R, Narasimhan B, Chu G (2025). `impute`: Imputation
for microarray data. <doi:10.18129/B9.bioc.impute>. R package version
1.85.0, <https://bioconductor.org/packages/impute>

Leek JT, Johnson WE, Parker HS, Fertig EJ, Jaffe AE, Zhang Y, Storey JD,
Torres LC (2025). `sva`: Surrogate Variable Analysis.
<doi:10.18129/B9.bioc.sva>, R package version 3.58.0,
...
OpenAI. (2025). ChatGPT (Nov 3 version) \[Large language model\].
